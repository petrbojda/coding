...
def main(setup_data):
    ...
    # f1ax1.plot(t, c, '-g', label='$h_{rcos}(t), \\beta = 1.0$')
    ...
    plt.title('Oversampled PRN code', loc='left')
    ...
    f2ax1.plot(tc, A1_c, '-g', label='$h_{rect}(t), \\beta = 1.0$')
    ...
    plt.title('Pulse-shaped Autocorrelated', loc='left')
